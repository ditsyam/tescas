...
WebUI.click(findTestObject('Object Repository/Page_Intel  Data Center Solutions, IoT, and_dfcb37/span_fa-intel-user-o icon-toggle-off'))

WebUI.click(findTestObject('Object Repository/Page_Intel Unified Login/button_Sign In'))
